...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        add(l14);
//        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ASimulatorSystem/icons/atm.jpg"));
//        Image i5 = i1.getImage().getScaledInstance(800, 750, Image.SCALE_DEFAULT);
//        ImageIcon i6 = new ImageIcon(i2);
//        JLabel l22 = new JLabel(i6);
//        l22.setBounds(0, 20, 800, 750);
//        add(l22);
        ...
        getContentPane().setBackground(Color.WHITE);//AAC7DC
